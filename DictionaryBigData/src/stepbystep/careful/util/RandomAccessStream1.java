 ...
 */
public final class RandomAccessStream1 extends InputStream {
	 ...
	 * @param inputstream
	 */
	public RandomAccessStream1(InputStream inputstream) {
		pointer = 0L;
		data = new ArrayList();
		length = 0;
		foundEOS = false;
	 ...
	 * @param ras
	 */
	public RandomAccessStream1(RandomAccessFile ras) {
		this.ras = ras;
	}
	...
	public int read(byte[] bytes, int off, int len) throws IOException {
		...
		if (l <= pointer) {
			...
			byte abyte1[] = (byte[]) data.get((int) (pointer >> BLOCK_SHIFT));
