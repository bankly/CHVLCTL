...
public class Stemmer {
	...
	j, k;
	private boolean sepecial = false;
	...
	public static String getOriginalWord(String value) {

		Stemmer s = new Stemmer();
		char[] arrCharValue = value.toCharArray();

		for (int i = 0; i < arrCharValue.length; i++) {
			int ch = arrCharValue[i];
			s.add((char) ch);
		}
